...
Write-ColorText "=== Building Unison MCP Server Docker Image ===" -Color Green
...
$images = docker images --format "table {{.Repository}}\t{{.Tag}}\t{{.Size}}\t{{.CreatedAt}}" | Select-String "unison-mcp-server"
