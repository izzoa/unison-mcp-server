"""
Version Tool - Display Unison MCP Server version and system information

This tool provides version information about the Unison MCP Server including
...
def fetch_github_version() -> Optional[tuple[str, str]]:
    ...
    github_url = "https://raw.githubusercontent.com/izzoa/unison-mcp-server/main/config.py"
...
class VersionTool(BaseTool):
    """
    Tool for displaying Unison MCP Server version and system information.
    ...
    async def execute(self, arguments: dict[str, Any]) -> list[TextContent]:
        """
        Display Unison MCP Server version and system information.
        ...
        """
        output_lines = ["# Unison MCP Server Version\n"]
