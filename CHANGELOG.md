...
- Sync version to config.py [skip ci]
  ([`c492735`](https://github.com/izzoa/unison-mcp-server/commit/c4927358720277efa0373b339bd8e06ee06498d0))
...
- Sync version to config.py [skip ci]
  ([`69a42a7`](https://github.com/izzoa/unison-mcp-server/commit/69a42a71d19d66f1d94d51fa27db29323e3d9a63))
...
- Sync version to config.py [skip ci]
  ([`cb97a89`](https://github.com/izzoa/unison-mcp-server/commit/cb97a891dec6ab7c56b8b35c277ab3680af384d9))
...
- Sync version to config.py [skip ci]
  ([`aa85644`](https://github.com/izzoa/unison-mcp-server/commit/aa85644c9b15893443107c3a62ec58cd7b9dc532))
...
- Sync version to config.py [skip ci]
  ([`94ff26c`](https://github.com/izzoa/unison-mcp-server/commit/94ff26c673a64087eb29f8f54c1828f1157c594a))
...
- Sync version to config.py [skip ci]
  ([`5c3dd75`](https://github.com/izzoa/unison-mcp-server/commit/5c3dd75ca6b259f590bfd5078ea8e2f684e52de4))

- Sync version to config.py [skip ci]
  ([`605633b`](https://github.com/izzoa/unison-mcp-server/commit/605633b2a2b044bbc5e41f2994dde27409a5b9b4))
...
- Sync version to config.py [skip ci]
  ([`bcfacce`](https://github.com/izzoa/unison-mcp-server/commit/bcfaccecd490859fe189f45df4cf5b8e102d7874))
...
- Sync version to config.py [skip ci]
  ([`c4461a4`](https://github.com/izzoa/unison-mcp-server/commit/c4461a466fab9c647b0a5035328c4d0f3e28f647))
...
- Sync version to config.py [skip ci]
  ([`d3de61f`](https://github.com/izzoa/unison-mcp-server/commit/d3de61f8787ab60261d09f2c7f362c50d2093799))
...
- Sync version to config.py [skip ci]
  ([`d256098`](https://github.com/izzoa/unison-mcp-server/commit/d2560983402abf084608f7750f05407a8d3e20a0))
...
- Sync version to config.py [skip ci]
  ([`3748d47`](https://github.com/izzoa/unison-mcp-server/commit/3748d47faba7d871f2dd379f2c8646aa8cd3c6e9))
...
- Sync version to config.py [skip ci]
  ([`749bc73`](https://github.com/izzoa/unison-mcp-server/commit/749bc7307949fa0b0e026bfcfbd546d7619eba8b))
...
- Sync version to config.py [skip ci]
  ([`84f6c4f`](https://github.com/izzoa/unison-mcp-server/commit/84f6c4fb241257b611f4b954c22a6b9340007a73))
...
- Sync version to config.py [skip ci]
  ([`7a1de64`](https://github.com/izzoa/unison-mcp-server/commit/7a1de6477aae88bfe7a2f677faf0794169651354))
...
- Sync version to config.py [skip ci]
  ([`4d3d177`](https://github.com/izzoa/unison-mcp-server/commit/4d3d177d91370097ca7ac4f922fa3a8b69ce3250))
...
- Sync version to config.py [skip ci]
  ([`9e163f9`](https://github.com/izzoa/unison-mcp-server/commit/9e163f9dc0654fc28961c9897b7c787a2b96e57d))

- Sync version to config.py [skip ci]
  ([`557e443`](https://github.com/izzoa/unison-mcp-server/commit/557e443a63ffd733fb41faaa8696f6f4bb2c2fd1))
...
- Sync version to config.py [skip ci]
  ([`04132f1`](https://github.com/izzoa/unison-mcp-server/commit/04132f1459f1e086afd8e3d456f671b63338f846))
...
- Sync version to config.py [skip ci]
  ([`942757a`](https://github.com/izzoa/unison-mcp-server/commit/942757a360a74c021b2a1aa63e394f18f5abcecd))
...
- Sync version to config.py [skip ci]
  ([`3ee0c8f`](https://github.com/izzoa/unison-mcp-server/commit/3ee0c8f555cb51b975700290919c2a8e2ada8cc4))
...
- Sync version to config.py [skip ci]
  ([`8c6f653`](https://github.com/izzoa/unison-mcp-server/commit/8c6f6532d843f7f1b283ce9b6472e5ba991efe16))
...
- Sync version to config.py [skip ci]
  ([`b205d71`](https://github.com/izzoa/unison-mcp-server/commit/b205d7159b674ce47ebc11af7255d1e3556fff93))
...
- Sync version to config.py [skip ci]
  ([`d08cdc6`](https://github.com/izzoa/unison-mcp-server/commit/d08cdc6691e0f68917f2824945905b7256e0e568))
...
- Sync version to config.py [skip ci]
  ([`b9408aa`](https://github.com/izzoa/unison-mcp-server/commit/b9408aae8860d43b1da0ba67f9db98db7e4de2cf))
...
- Sync version to config.py [skip ci]
  ([`23c9b35`](https://github.com/izzoa/unison-mcp-server/commit/23c9b35d5226b07b59a4c4b3d7833ba81b019ea8))
...
- Sync version to config.py [skip ci]
  ([`728fb43`](https://github.com/izzoa/unison-mcp-server/commit/728fb439b929c9dc37646b24537ae043208fda7d))
...
- Sync version to config.py [skip ci]
  ([`52245b9`](https://github.com/izzoa/unison-mcp-server/commit/52245b91eaa5d720f8c3b21ead55248dd8e8bd57))
...
- Sync version to config.py [skip ci]
  ([`4c34541`](https://github.com/izzoa/unison-mcp-server/commit/4c3454121c3c678cdfe8ea03fa77f4dd414df9bc))
...
- Sync version to config.py [skip ci]
  ([`c27e81d`](https://github.com/izzoa/unison-mcp-server/commit/c27e81d6d2f22978816f798a161a869d1ab5f025))
...
- Sync version to config.py [skip ci]
  ([`3e5fa96`](https://github.com/izzoa/unison-mcp-server/commit/3e5fa96c981bbd7b844a9887a518ffe266b78e9b))
...
- Sync version to config.py [skip ci]
  ([`70ae62a`](https://github.com/izzoa/unison-mcp-server/commit/70ae62a2cd663c3abcabddd1be1bc6ed9512d7df))
...
- Sync version to config.py [skip ci]
  ([`c1c75ba`](https://github.com/izzoa/unison-mcp-server/commit/c1c75ba304c2840329650c46273e87eab9b05906))

- Sync version to config.py [skip ci]
  ([`0fa9b66`](https://github.com/izzoa/unison-mcp-server/commit/0fa9b6658099c8e0d79fda0c7d2347f62d0e6137))
...
- Sync version to config.py [skip ci]
  ([`74fdd36`](https://github.com/izzoa/unison-mcp-server/commit/74fdd36de92d34681fcc5a2f772c3d05634f0a55))
...
- Sync version to config.py [skip ci]
  ([`004e379`](https://github.com/izzoa/unison-mcp-server/commit/004e379cf2f1853829dccb15fa72ec18d282f1a4))
...
- Sync version to config.py [skip ci]
  ([`71e7cd5`](https://github.com/izzoa/unison-mcp-server/commit/71e7cd55b1f4955a6d718fddc0de419414d133b6))
...
- Sync version to config.py [skip ci]
  ([`76bf98e`](https://github.com/izzoa/unison-mcp-server/commit/76bf98e5cd972dabd3c79b25fcb9b9a717b23f6d))
...
- Sync version to config.py [skip ci]
  ([`e7920d0`](https://github.com/izzoa/unison-mcp-server/commit/e7920d0ed16c0e6de9d1ccaa0b58d3fb5cbd7f2f))
...
- Sync version to config.py [skip ci]
  ([`1854b1e`](https://github.com/izzoa/unison-mcp-server/commit/1854b1e26b705cda0dc3f4d733647f1454aa0352))
...
- Sync version to config.py [skip ci]
  ([`e02e78d`](https://github.com/izzoa/unison-mcp-server/commit/e02e78d903b35f4c01b8039f4157e97b38d3ec7b))
...
- Sync version to config.py [skip ci]
  ([`d54bfdd`](https://github.com/izzoa/unison-mcp-server/commit/d54bfdd49797d076ec9cade44c56292a8089c744))
...
- Sync version to config.py [skip ci]
  ([`f2142a2`](https://github.com/izzoa/unison-mcp-server/commit/f2142a22ec50abc54b464eedd6b8239d20c509be))
...
- Sync version to config.py [skip ci]
  ([`bc4a27b`](https://github.com/izzoa/unison-mcp-server/commit/bc4a27b18a4a3f45afb22178e61ea0be4d6a273c))
...
- Sync version to config.py [skip ci]
  ([`0d46976`](https://github.com/izzoa/unison-mcp-server/commit/0d46976a8aa85254e4dbe06f5e71161cd3b13938))

- Sync version to config.py [skip ci]
  ([`8296bf8`](https://github.com/izzoa/unison-mcp-server/commit/8296bf871c39597a904c70e7d98c72fcb4dc5a84))
...
- Sync version to config.py [skip ci]
  ([`18095d7`](https://github.com/izzoa/unison-mcp-server/commit/18095d7d398e4bf3d24c57a52c81ac619acb1b89))
...
- Sync version to config.py [skip ci]
  ([`ae8749a`](https://github.com/izzoa/unison-mcp-server/commit/ae8749ab37bdaa7e225b5219820adeb74ca9a552))
...
- Sync version to config.py [skip ci]
  ([`054e34e`](https://github.com/izzoa/unison-mcp-server/commit/054e34e31ca5bee5a11c0e3e6537f58e8897c79c))

- Sync version to config.py [skip ci]
  ([`c0334d7`](https://github.com/izzoa/unison-mcp-server/commit/c0334d77922f1b05e3fd755851da112567fb9ae6))
...
- Sync version to config.py [skip ci]
  ([`ddb20a6`](https://github.com/izzoa/unison-mcp-server/commit/ddb20a6cdb8cdeee27c0aacb0b9c794283b5774c))
...
- Sync version to config.py [skip ci]
  ([`03addcf`](https://github.com/izzoa/unison-mcp-server/commit/03addcfa2d3aed5086fe4c94e8b9ae56229a93ae))
...
- Sync version to config.py [skip ci]
  ([`539bc72`](https://github.com/izzoa/unison-mcp-server/commit/539bc72f1ca2a2cadcccad02de1fd5fc22cd0415))
...
- Sync version to config.py [skip ci]
  ([`8e32ef3`](https://github.com/izzoa/unison-mcp-server/commit/8e32ef33e3ce7ab2a9d7eb5c90fe5b93b12d5c26))
...
- Sync version to config.py [skip ci]
  ([`5714e20`](https://github.com/izzoa/unison-mcp-server/commit/5714e2016405f7607b44d78f85081c7ccee706e5))
...
- Sync version to config.py [skip ci]
  ([`bf2196c`](https://github.com/izzoa/unison-mcp-server/commit/bf2196cdd58ae8d8d93597f2be69c798265d678f))
...
- Sync version to config.py [skip ci]
  ([`e434a26`](https://github.com/izzoa/unison-mcp-server/commit/e434a2614af82efd15de4dd94b2c30559c91414e))
...
- Sync version to config.py [skip ci]
  ([`e78fe35`](https://github.com/izzoa/unison-mcp-server/commit/e78fe35a1b64cc0ed89664440ef7c7b94495d7dc))
...
- Sync version to config.py [skip ci]
  ([`a6c9b92`](https://github.com/izzoa/unison-mcp-server/commit/a6c9b9212c77852d9e9a8780f4bc3e53b3bfed2f))
...
- Sync version to config.py [skip ci]
  ([`722f6f8`](https://github.com/izzoa/unison-mcp-server/commit/722f6f86ae228206ce0094d109a3b20499d4e11a))
...
- Sync version to config.py [skip ci]
  ([`e47a7e8`](https://github.com/izzoa/unison-mcp-server/commit/e47a7e89d5bfad0bb0150cb3207f1a37dc91b170))
...
- Sync version to config.py [skip ci]
  ([`7ce66bd`](https://github.com/izzoa/unison-mcp-server/commit/7ce66bd9508865cef64dc30936e86e37c1a306d0))
...
- Sync version to config.py [skip ci]
  ([`0836213`](https://github.com/izzoa/unison-mcp-server/commit/0836213071d0037d8a6d2e64d34ab5df79b8e684))
...
- Sync version to config.py [skip ci]
  ([`b6c4bca`](https://github.com/izzoa/unison-mcp-server/commit/b6c4bca158e4cee1ae4abd08b7e55216ebffba2d))
...
- Sync version to config.py [skip ci]
  ([`b0fe956`](https://github.com/izzoa/unison-mcp-server/commit/b0fe956f8a50240507e0fc911f0800634c15e9f7))
...
- Sync version to config.py [skip ci]
  ([`692016c`](https://github.com/izzoa/unison-mcp-server/commit/692016c6205ed0a0c3d9e830482d88231aca2e31))
...
- Sync version to config.py [skip ci]
  ([`c0f822f`](https://github.com/izzoa/unison-mcp-server/commit/c0f822ffa23292d668f7b5dd3cb62e3f23fb29af))
...
- Sync version to config.py [skip ci]
  ([`b8479fc`](https://github.com/izzoa/unison-mcp-server/commit/b8479fc638083d6caa4bad6205e3d3fcab830aca))
...
- Sync version to config.py [skip ci]
  ([`e3ebf4e`](https://github.com/izzoa/unison-mcp-server/commit/e3ebf4e94eba63acdc4df5a0b0493e44e3343dd1))
...
- Sync version to config.py [skip ci]
  ([`28cabe0`](https://github.com/izzoa/unison-mcp-server/commit/28cabe0833661b0bab56d4227781ee2da332b00c))
...
- Sync version to config.py [skip ci]
  ([`4d6f1b4`](https://github.com/izzoa/unison-mcp-server/commit/4d6f1b41005dee428c955e33f04f8f9f6259e662))
...
- Sync version to config.py [skip ci]
  ([`1209064`](https://github.com/izzoa/unison-mcp-server/commit/12090646ee83f2368311d595d87ae947e46ddacd))
...
- Sync version to config.py [skip ci]
  ([`9735469`](https://github.com/izzoa/unison-mcp-server/commit/973546990f2c45afa93f1aa6de33ff461ecf1a83))
...
- Sync version to config.py [skip ci]
  ([`d6e6808`](https://github.com/izzoa/unison-mcp-server/commit/d6e6808be525192ab8388c0f01bc1bbd016fc23a))
...
- Sync version to config.py [skip ci]
  ([`9da5c37`](https://github.com/izzoa/unison-mcp-server/commit/9da5c37809cbde19d0c7ffed273ae93ca883a016))
...
- Sync version to config.py [skip ci]
  ([`1254205`](https://github.com/izzoa/unison-mcp-server/commit/12542054a214022d3f515e53367f5bf3a77fb289))
...
- Sync version to config.py [skip ci]
  ([`4f82f65`](https://github.com/izzoa/unison-mcp-server/commit/4f82f6500502b7b6ba41875a560c41f6a63b683b))
