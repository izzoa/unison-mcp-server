...
class TestSupportedModelsAliases:
    ...
    def test_gemini_provider_aliases(self):
        ...
        for alias in well_known_aliases:
            assert is_valid_model(ProviderType.GOOGLE, alias), f"Alias '{alias}' should resolve to a valid Gemini model"
    ...
    def test_openai_provider_aliases(self):
        ...
        for alias in well_known_aliases:
            assert is_valid_model(ProviderType.OPENAI, alias), f"Alias '{alias}' should resolve to a valid OpenAI model"
    ...
    def test_xai_provider_aliases(self):
        ...
        for alias in well_known_aliases:
            assert is_valid_model(ProviderType.XAI, alias), f"Alias '{alias}' should resolve to a valid XAI model"
    ...
    def test_dial_provider_aliases(self):
        ...
        for alias in well_known_aliases:
            assert provider.validate_model_name(alias), f"Alias '{alias}' should resolve to a valid DIAL model"
